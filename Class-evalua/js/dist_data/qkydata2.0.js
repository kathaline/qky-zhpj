...
define({
	navdata:{/*导航数据*/
		...
		otherli:[["切换身份","href='default_html/switch_user.html'"],["数据设置","href='html/00set-term.html'"],["账户设置","href='default_html/account_settings.html'"],["个人设置","href='#'"],["退出","href='default_html/login.html'"]],//设置菜单
